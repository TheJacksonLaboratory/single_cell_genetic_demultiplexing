    ...
    process demuxRun {
      ...
      //  label 'short'
       ...
       //     file infile from input
        ...
        // if( mode == 'souporcell' )
        """
       singularity exec ${params.souporcellSif} souporcell_pipeline.py  --bam ${params.input} -b ${params.barcode} -f ${params.fasta} --known_genotypes ${params.vcf} --known_genotypes_sample_names C57BL_6NJ NZO_HlLtJ CAST_EiJ --ploidy 2 --min_alt 10 --min_ref 10 --no_umi True -t ${params.threads} -o output -k ${params.clusters} --ignore True
        """
        }
